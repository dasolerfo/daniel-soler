<template>
    <div class="w-max-7xl items-center bg-gradient-to-r bg-gray-800 box-border"> 
      <h2
        v-intersect
      ...
      <div class=" box-border pl-30 pr-30 w-full mt-18">
          <div id="stack" class="relative text-white text-xl mt-10 flex max-w-7xl m-auto bg-gray-700 rounded-lg text-center ">
            <p
  ...
  data() {
    const tecnologies: Technology[][] = [
      ...
      [
        ...
        { name: 'Git', icon: 'assets/logos/Git.svg', bgcolor: 'white', textColor: 'black' },
        { name: 'GitHub', icon: 'assets/logos/GitHub.svg', bgcolor: 'white', textColor: 'black' },
        { name: 'AWS', icon: 'assets/logos/AWS.svg', bgcolor: '#FF9900', textColor: '#000000' },
